...
class Experiment:
	...
	def __init__(self, p_oExperimentPhases = []):
		print "DEBUG: Entering Experiment(experimentPhases) constructor"

		self.__oExperimentPhases = p_oExperimentPhases
		print "DEBUG: \texperimentPhases =" , self.__oExperimentPhases

		print "DEBUG: Exiting Experiment(experimentPhases) constructor"
	...
	"""
	def runPhases(self, p_oResults):
		print "DEBUG: Entering Experiment.runPhases(results)"
		...
		for ii in range(self.__oExperimentPhases.__len__()):
			...
			self.__oExperimentPhases[ii].runBlocks(p_oResults)
		...
		print "DEBUG: Exiting Experiment.runPhases(results)"
